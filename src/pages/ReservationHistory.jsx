            ...
            {reservations.map((res) => (
              <animated.div
                ...
                style={{
                  ...
                  margin: "5px auto",
                  background:
                    "linear-gradient(135deg, #ffffff 0%, #f8ece4 100%)",
              ...
              >
                ...
                >
                  <span style={{ color: "#D99A2B" }}>عدد الأيام:</span>
                  <span style={{ fontSize: "1.5rem" }}>{res.days}</span>
                </div>
                <div
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  <span style={{ fontSize: "1.5rem" }}>{res.bakery}</span>
                </div>
                <div
                  style={{
                    display: "flex",
